...
def test_heston_call_fourier_vs_mc(v0, rho, eta, theta, kappa, K):
    ...
    # Fourier damping
    fourier_price = FourierDampingEngine(option=option, process=process, X0=[S0,v0], r=r, alpha=1.5, day=today, b=250, n=5000)
...
@pytest.mark.parametrize("v0,rho,eta,theta,kappa",PARAMETER_SETS)
@pytest.mark.parametrize("K",STRIKES)
def test_heston_put_fourier_vs_mc(v0, rho, eta, theta, kappa, K):
